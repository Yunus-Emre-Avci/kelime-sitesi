...
export const seedWords: SeedWord[] = [
  ...
  },
  {
    english: "barrier",
    phonetic: "/ˈbæriə/",
    turkishMeaning: "engel, bariyer",
    turkishDefinition: "Bir şeyin olmasını engelleyen veya zorlaştıran şey.",
    dictionaryDefinition: "(n) something that prevents something else from happening or makes it more difficult",
    exampleSentence: "Trade barriers can make it difficult for businesses to export goods.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    ...
    turkishMeaning: "yaşam maliyeti, hayat pahalılığı",
    turkishDefinition: "Bir kişinin yaşaması için gereken para miktarı.",
    dictionaryDefinition: "(n phr) the amount of money a person needs to live",
    exampleSentence: "The cost of living in big cities is usually higher than in rural areas.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "customs procedures",
    phonetic: "/ˈkʌstəmz prəˈsiːdʒəz/",
    turkishMeaning: "gümrük işlemleri",
    turkishDefinition: "Hangi ürünlerin bir ülkeye girip çıkabileceğine karar veren resmi işlemler.",
    dictionaryDefinition: "(n phr) official actions deciding what products can or can not enter or leave a country",
    exampleSentence: "New customs procedures have been introduced to speed up trade.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "food security",
    phonetic: "/fuːd sɪˈkjʊərəti/",
    turkishMeaning: "gıda güvenliği",
    turkishDefinition: "Bir yerin halkını beslemek için yeterli gıda üretebilmesi veya alabilmesi.",
    dictionaryDefinition: "(n phr) the fact that a place is able to make or get enough food to feed its people",
    exampleSentence: "Climate change is a major threat to global food security.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "red tape",
    phonetic: "/red teɪp/",
    turkishMeaning: "bürokrasi, kırtasiyecilik",
    turkishDefinition: "İşleri zorlaştıran veya yavaşlatan gereksiz resmi kurallar.",
    dictionaryDefinition: "(n phr) official rules that seem unnecessary and make things harder or slower",
    exampleSentence: "It took months to get the license due to all the red tape.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "reform",
    phonetic: "/rɪˈfɔːm/",
    turkishMeaning: "reform, ıslahat",
    turkishDefinition: "Bir yasayı veya sistemi daha modern veya etkili hale getirmek için iyileştirmek.",
    dictionaryDefinition: "(v) to improve a law or system making it more modern or effective",
    exampleSentence: "The government is planning to reform the education system.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "the Silk Road",
    phonetic: "/ðə sɪlk rəʊd/",
    turkishMeaning: "İpek Yolu",
    turkishDefinition: "Çin'den başlayıp Orta Asya üzerinden Akdeniz ve Avrupa'ya kadar uzanan eski ticaret yolu.",
    dictionaryDefinition: "(n) an ancient trade route mainly across land from China, across central Asia to the Eastern Mediterranean and Europe",
    exampleSentence: "The Silk Road played a significant role in the exchange of goods and ideas between East and West.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "dry port",
    phonetic: "/draɪ pɔːt/",
    turkishMeaning: "kuru liman",
    turkishDefinition: "Denize kıyısı olmayan, malların yüklenip boşaltıldığı taşıma merkezi.",
    dictionaryDefinition: "(n) a transport centre where goods are loaded and unloaded, but which is not near water",
    exampleSentence: "The new dry port will help reduce congestion at the coastal harbors.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "logistics hub",
    phonetic: "/ləˈdʒɪstɪks hʌb/",
    turkishMeaning: "lojistik merkez",
    turkishDefinition: "Ürünlerin teslim alındığı, depolandığı ve dağıtıldığı merkez.",
    dictionaryDefinition: "(n) a centre where goods are received, stored, and then sent out to different places",
    exampleSentence: "Istanbul is becoming a major logistics hub between Europe and Asia.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    ...
    turkishDefinition: "Ulaşım ve enerji gibi bir ülkenin etkin çalışması için gereken temel sistemler.",
    dictionaryDefinition: "(n) the basic systems and services, such as transport and power, that a country uses to work effectively",
    exampleSentence: "The government is investing heavily in the country's transportation infrastructure.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
    english: "think tank",
    phonetic: "/ˈθɪŋk tæŋk/",
    turkishMeaning: "düşünce kuruluşu",
    turkishDefinition: "Problemleri inceleyen ve çözümler üreten uzmanlar grubu.",
    dictionaryDefinition: "(n) a group of experts who work together to study a problem and suggest solutions",
    exampleSentence: "The think tank published a report on future economic trends.",
    level: "B1",
    tags: ["Unit 1"],
  },
  {
  ...
  },
  {
    english: "incentive",
    phonetic: "/ɪnˈsen.tɪv/",
    turkishMeaning: "teşvik, özendirme",
    turkishDefinition: "Birini bir şeyi yapmaya teşvik eden veya cesaretlendiren şey.",
    dictionaryDefinition: "(n) something that encourages a person to do something",
    exampleSentence: "The government offers a tax incentive to companies that invest in renewable energy.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    ...
    turkishDefinition: "Bir şeyi yapmanıza izin veren resmi belge.",
    dictionaryDefinition: "(n) an official document that allows you to do something",
    exampleSentence: "You need a special permit to park your car in this area.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    english: "rebate",
    phonetic: "/ˈriː.beɪt/",
    turkishMeaning: "iade, kısmi geri ödeme",
    turkishDefinition: "Vergi veya ödeme yaptıktan sonra hükümet veya bir kurum tarafından size iade edilen para.",
    dictionaryDefinition: "(n) money that is returned to you by the government after you have paid tax",
    exampleSentence: "The company offered a cash rebate to customers who bought a new refrigerator.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    ...
    phonetic: "/ɪˈlɪtərəsi/",
    turkishMeaning: "okuma yazma bilmeme",
    turkishDefinition: "Okuma ve yazma yeteneğinin olmaması durumu.",
    dictionaryDefinition: "(n) a lack of the ability to read and write",
    exampleSentence: "Programmes to combat adult illiteracy have been successful in many regions.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    english: "disadvantaged",
    phonetic: "/ˌdɪsədˈvæntɪdʒd/",
    turkishMeaning: "dezavantajlı, mahrum",
    turkishDefinition: "Çoğu insanın sahip olduğu yaşam koşulları, eğitim vb. imkanlara sahip olmama.",
    dictionaryDefinition: "(adj) not having the standard of living conditions, education, etc. that most people have",
    exampleSentence: "The government provides extra support for children from disadvantaged backgrounds.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    english: "drop out",
    phonetic: "/drɒp aʊt/",
    turkishMeaning: "okulu bırakmak, ayrılmak",
    turkishDefinition: "Yapacağınız bir şeyi yapmamak (örneğin bir kursu bitirmemek).",
    dictionaryDefinition: "(phr v) to not do something that you were going to do (e.g. not finish a course)",
    exampleSentence: "He decided to drop out of university to start his own business.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    english: "stigma",
    phonetic: "/ˈstɪɡmə/",
    turkishMeaning: "damga, utanç lekesi",
    turkishDefinition: "Toplumun bir şey hakkında duyduğu güçlü onaylamama duygusu, özellikle de bu haksız olduğunda.",
    ...
    exampleSentence: "There is still a social stigma attached to mental illness in some cultures.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
    english: "turn to sth",
    phonetic: "/tɜːrn tuː/",
    turkishMeaning: "bir şeye yönelmek (genellikle kötü)",
    turkishDefinition: "Kötü bir şey yapmaya başlamak, özellikle mutsuz olduğunda.",
    dictionaryDefinition: "(phr v) to start to do something bad, especially when unhappy",
    exampleSentence: "Some people turn to crime when they cannot find a job.",
    level: "B1",
    tags: ["Unit 2"],
  },
  {
  ...
  {
    english: "absolutely phenomenal",
    phonetic: "/ˌæbsəˈluːtli fəˈnɒmɪnl/",
    turkishMeaning: "kesinlikle harika",
    turkishDefinition: "Tamamen şaşırtıcı ve mükemmel.",
    dictionaryDefinition: "(adj phr) completely amazing",
    exampleSentence: "The singer's performance was absolutely phenomenal.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    english: "corruption of data",
    phonetic: "/kəˈrʌpʃən əv ˈdeɪtə/",
    turkishMeaning: "veri bozulması",
    turkishDefinition: "Bilginin hasar görmesi veya kaybolması durumu.",
    dictionaryDefinition: "(n phr) damage to or loss of information",
    exampleSentence: "A power failure can lead to the corruption of data on your hard drive.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    ...
    turkishMeaning: "çığır açan",
    turkishDefinition: "Tamamen yeni fikirlere dayanan.",
    dictionaryDefinition: "(adj) based on completely new ideas",
    exampleSentence: "The scientist received an award for his ground-breaking research in genetics.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    ...
    turkishMeaning: "radyasyon",
    turkishDefinition: "Nükleer reaksiyondan gelen ve büyük miktarlarda tehlikeli olabilen bir enerji türü.",
    dictionaryDefinition: "(n) a form of energy that comes from a nuclear reaction and can be dangerous in large amounts",
    exampleSentence: "Workers at the nuclear plant must wear special suits to protect themselves from radiation.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    english: "research facility",
    phonetic: "/rɪˈsɜːtʃ fəˈsɪləti/",
    turkishMeaning: "araştırma tesisi",
    turkishDefinition: "Bilim insanlarının keşifler yapmak için çalıştığı yer.",
    dictionaryDefinition: "(n phr) a place where scientists work to make discoveries",
    exampleSentence: "The university is building a state-of-the-art research facility for biology.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    english: "countless",
    phonetic: "/ˈkaʊntləs/",
    turkishMeaning: "sayısız, çok sayıda",
    turkishDefinition: "Çok fazla sayıda olan, sayılamayacak kadar çok.",
    dictionaryDefinition: "(adj) very many",
    exampleSentence: "She has spent countless hours preparing for the exam.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    ...
    phonetic: "/məʊld/",
    turkishMeaning: "küf",
    turkishDefinition: "Eski yiyeceklerin üzerinde veya nemli ortamlarda büyüyen madde.",
    dictionaryDefinition: "(n) a soft black, green or grey substance that grows on old food or objects that have been left for too long in warm, wet air",
    exampleSentence: "There was mould growing on the piece of bread.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    english: "resistant",
    phonetic: "/rɪˈzɪstənt/",
    turkishMeaning: "dirençli, dayanıklı",
    turkishDefinition: "Bir şeyden zarar görmeyen veya etkilenmeyen.",
    dictionaryDefinition: "(adj) not harmed or affected by something",
    exampleSentence: "This new type of paint is resistant to water and heat.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    english: "state of mind",
    phonetic: "/steɪt əv maɪnd/",
    turkishMeaning: "ruh hali, zihin durumu",
    turkishDefinition: "Belirli bir zamanda nasıl hissettiğiniz.",
    dictionaryDefinition: "(n) how you are feeling at a particular time",
    exampleSentence: "A positive state of mind can help you recover faster from an illness.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    english: "physiotherapy",
    phonetic: "/ˌfɪziəʊˈθerəpi/",
    turkishMeaning: "fizyoterapi",
    turkishDefinition: "Kas, eklem veya sinir sorunlarının tedavisi.",
    dictionaryDefinition: "(n) the treatment of problems of the muscles, joints, or nerves",
    exampleSentence: "He is having physiotherapy to help him walk again after the accident.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    ...
    turkishMeaning: "rehabilitasyon",
    turkishDefinition: "Bir kişinin ciddi bir hastalıktan sonra tekrar normal bir hayat yaşamasına yardımcı olma süreci.",
    dictionaryDefinition: "(n) to help someone live a normal life again after they have had a serious illness",
    exampleSentence: "She spent several months in a rehabilitation centre following her surgery.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
    ...
    phonetic: "/ˈtjuːmə/",
    turkishMeaning: "tümör, ur",
    turkishDefinition: "Yumru haline gelebilen veya hastalığa neden olabilen hastalıklı hücre kitlesi.",
    dictionaryDefinition: "(n) a mass of diseased cells that might become a lump or cause illness",
    exampleSentence: "The doctors performed an operation to remove the tumour.",
    level: "B1",
    tags: ["Unit 3"],
  },
  {
  ...
  {
    english: "polar ice cap",
    phonetic: "/ˈpəʊlə(r) aɪs kæp/",
    turkishMeaning: "kutup buzulu",
    turkishDefinition: "Kuzey veya Güney Kutbu yakınlarında bulunan ve kara alanını kalıcı olarak kaplayan kalın buz tabakası.",
    dictionaryDefinition: "(n) a thick layer of ice near the North or South Pole which permanently covers an area of land",
    exampleSentence: "The melting of the polar ice caps is a major sign of global warming.",
    level: "B2",
    tags: ["Unit 4"],
  },
  {
    ...
    turkishMeaning: "dağılım",
    turkishDefinition: "Bir şeyin bir grup veya bölge içinde bölünme ve paylaşılma şekli.",
    dictionaryDefinition: "(n) the way something is divided and shared in a group or area",
    exampleSentence: "The distribution of wealth is unequal in many parts of the world.",
    level: "B2",
    tags: ["Unit 4"],
  },
  {
    english: "transform",
    phonetic: "/trænsˈfɔːm/",
    turkishMeaning: "dönüştürmek, değiştirmek",
    turkishDefinition: "Bir şeyi tamamen değiştirmek, genellikle iyileştirmek.",
    dictionaryDefinition: "(v) to change something completely, often to improve it",
    exampleSentence: "New technology has the power to transform the way we live and work.",
    level: "B2",
    tags: ["Unit 4"],
  },
  {
    ...
    turkishMeaning: "su rezervuarı, hazne",
    turkishDefinition: "Suyu depolamak ve sağlamak için kullanılan doğal veya yapay göl.",
    dictionaryDefinition: "(n) a natural or artificial lake for storing and supplying water",
    exampleSentence: "The local reservoir provides water for the entire city.",
    level: "B2",
    tags: ["Unit 4"],
  },
  {
  ...
  },
  {
    ...
    turkishDefinition: "Bir şeyi ayrıntılı olarak incelemek ve çözümlemek.",
    dictionaryDefinition: "(v) to study something in detail",
    exampleSentence: "Researchers are trying to analyze the data from the experiment.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "comment",
    phonetic: "/ˈkɒment/",
    turkishMeaning: "yorum yapmak, fikir belirtmek",
    turkishDefinition: "Bir konu veya durum hakkında görüş bildirmek.",
    dictionaryDefinition: "(v) to express an opinion",
    exampleSentence: "He refused to comment on the recent changes.",
    level: "B1",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishMeaning: "kompozisyon, düzenleme",
    turkishDefinition: "Bir resimdeki veya sanat eserindeki ögelerin düzenlenme şekli.",
    dictionaryDefinition: "(n) the way that things are arranged in an image",
    exampleSentence: "The composition of this photograph is incredibly balanced.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Özgün, yeni ve sıra dışı fikirler üretebilme yeteneği.",
    dictionaryDefinition: "(n) the ability to produce original, new and unusual ideas",
    exampleSentence: "Art classes encourage children to use their creativity.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Bir şeyin veya birinin eksik ya da kötü yanlarını belirtme eylemi.",
    dictionaryDefinition: "(n) the act of saying that something or somebody is bad",
    exampleSentence: "Constructive criticism can help you improve your work.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "abstract",
    phonetic: "/ˈæbstrækt/",
    turkishMeaning: "soyut",
    turkishDefinition: "Gerçek nesnelerle veya insanlarla ilgili olmayan, kavramsal.",
    dictionaryDefinition: "(adj) not of real things or people",
    exampleSentence: "Abstract art focuses on shapes and colors rather than realistic forms.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Bir şeyin doğruluğunu veya varlığını kabul etmek.",
    dictionaryDefinition: "(v) to agree; to admit something is true",
    exampleSentence: "He refused to acknowledge his mistake.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "aesthetic",
    phonetic: "/esˈθetɪk/",
    turkishMeaning: "estetik",
    turkishDefinition: "Güzellikle veya güzelliğin incelenmesiyle ilgili olan.",
    dictionaryDefinition: "(adj) relating to the enjoyment or study of beauty, or showing great beauty",
    exampleSentence: "The new building has little aesthetic value.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "avant-garde",
    phonetic: "/ˌævɑ̃ːˈɡɑːd/",
    turkishMeaning: "yenilikçi, öncü",
    turkishDefinition: "Çok özgün ve modern fikirlere, tarzlara sahip olan.",
    dictionaryDefinition: "(adj) relating to ideas and styles which are very original and modern",
    exampleSentence: "The gallery is known for exhibiting avant-garde art.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishMeaning: "kavramsal",
    turkishDefinition: "Fikirlere veya prensiplere dayanan.",
    dictionaryDefinition: "(adj) based on ideas or principles",
    exampleSentence: "The conceptual framework of the study is well-defined.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    phonetic: "/kənˈtempərəri/",
    turkishMeaning: "çağdaş, modern",
    turkishDefinition: "Günümüzde var olan veya gerçekleşen.",
    dictionaryDefinition: "(adj) existing or happening now",
    exampleSentence: "She is a student of contemporary literature.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishMeaning: "kasten, bilerek",
    turkishDefinition: "Planlı bir şekilde veya bilerek yapılan.",
    dictionaryDefinition: "(adv) intentionally or in a planned way",
    exampleSentence: "I'm sure he did it deliberately to annoy me.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishMeaning: "ayrım, fark",
    turkishDefinition: "Benzer şeyler arasındaki belirgin fark.",
    dictionaryDefinition: "(n) a difference between similar things",
    exampleSentence: "There is a clear distinction between the two theories.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "established",
    phonetic: "/ɪˈstæblɪʃt/",
    turkishMeaning: "köklü, yerleşmiş",
    turkishDefinition: "Genel olarak kabul gören, uzun bir geçmişi olan.",
    dictionaryDefinition: "(adj) generally accepted or familiar; having a long history",
    exampleSentence: "They are an established company with a good reputation.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "expressive",
    phonetic: "/ɪkˈspresɪv/",
    turkishMeaning: "anlamlı, ifade edici",
    turkishDefinition: "Birinin ne düşündüğünü veya hissettiğini açıkça gösteren.",
    dictionaryDefinition: "(adj) showing what somebody thinks or feels",
    exampleSentence: "She has a wonderfully expressive face.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "figurative",
    phonetic: "/ˈfɪɡərətɪv/",
    turkishMeaning: "figüratif, mecazi",
    turkishDefinition: "Gerçek hayattaki kişi veya nesnelere benzer bir şekilde gösteren.",
    dictionaryDefinition: "(adj) showing people or things in a similar way to real life",
    exampleSentence: "Figurative art represents realistic forms rather than abstract ones.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "lifelike",
    phonetic: "/ˈlaɪflaɪk/",
    turkishMeaning: "gerçeğe çok benzeyen, canlı gibi",
    turkishDefinition: "Çok gerçekçi görünen.",
    dictionaryDefinition: "(adj) looks very real",
    exampleSentence: "The statue was completely lifelike.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "mechanical",
    phonetic: "/məˈkænɪkəl/",
    turkishMeaning: "mekanik",
    turkishDefinition: "Makinelerle ilgili olan.",
    dictionaryDefinition: "(adj) related to machines",
    exampleSentence: "The breakdown was due to a mechanical failure.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "medium",
    phonetic: "/ˈmiːdiəm/",
    turkishMeaning: "araç, yöntem, malzeme",
    turkishDefinition: "Sanat eseri yaratmak için kullanılan malzeme.",
    dictionaryDefinition: "(n) a material used to create art",
    exampleSentence: "Oil paint is his favorite medium.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "moving",
    phonetic: "/ˈmuːvɪŋ/",
    turkishMeaning: "dokunaklı, duygulandıran",
    turkishDefinition: "Güçlü üzüntü veya sempati duyguları uyandıran.",
    dictionaryDefinition: "(adj) causing strong feelings of sadness or sympathy",
    exampleSentence: "It was a very moving story.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "notion",
    phonetic: "/ˈnəʊʃən/",
    turkishMeaning: "kavram, düşünce, fikir",
    turkishDefinition: "Bir inanç veya fikir.",
    dictionaryDefinition: "(n) a belief or idea",
    exampleSentence: "I don't agree with the notion that money brings happiness.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "objective",
    phonetic: "/əbˈdʒektɪv/",
    turkishMeaning: "nesnel, objektif",
    turkishDefinition: "Gerçeklere dayanan ve kişisel duygulardan etkilenmeyen.",
    dictionaryDefinition: "(adj) based on facts and reality",
    exampleSentence: "We must try to be objective when making this decision.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "perceive",
    phonetic: "/pəˈsiːv/",
    turkishMeaning: "algılamak, fark etmek",
    turkishDefinition: "Bir şeyi belirli bir şekilde düşünmek veya görmek.",
    dictionaryDefinition: "(v) to think of in a particular way",
    exampleSentence: "How do you perceive your role in the company?",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishMeaning: "önem, anlam",
    turkishDefinition: "Bir şeyin önemli olma durumu.",
    dictionaryDefinition: "(n) importance",
    exampleSentence: "The discovery has great significance for researchers.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishMeaning: "gelişmiş, karmaşık, kültürlü",
    turkishDefinition: "Son derece gelişmiş ve karmaşık olan.",
    dictionaryDefinition: "(adj) highly developed and complex",
    exampleSentence: "They use highly sophisticated computer systems.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "a range of",
    phonetic: "/ə reɪndʒ əv/",
    turkishMeaning: "bir dizi, çeşitli",
    turkishDefinition: "Birbiriyle ilişkili veya benzer olan bir grup şey.",
    dictionaryDefinition: "(n phr) a set of similar things",
  ...
  },
  {
    english: "adapt",
    phonetic: "/əˈdæpt/",
    turkishMeaning: "uyum sağlamak, adapte olmak",
    turkishDefinition: "Farklı koşullara veya kullanımlara göre değişmek veya değiştirmek.",
    dictionaryDefinition: "(v) to adjust to different conditions or uses",
    exampleSentence: "It took him a while to adapt to the new climate.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "capacity",
    phonetic: "/kəˈpæsəti/",
    turkishMeaning: "konum, sıfat, rol",
    turkishDefinition: "Belirli bir pozisyon, görev veya rol.",
    dictionaryDefinition: "(n) a particular position or job; a role",
    exampleSentence: "She was acting in her capacity as manager.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "cope",
    phonetic: "/kəʊp/",
    turkishMeaning: "başa çıkmak, üstesinden gelmek",
    turkishDefinition: "Zorluklarla veya problemlerle başarılı bir şekilde mücadele etmek.",
    dictionaryDefinition: "(v) to deal with problems successfully",
    exampleSentence: "It must be difficult to cope with three small children and a job.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishMeaning: "demografik",
    turkishDefinition: "İnsan popülasyonları ve bunların büyüklüğü, büyümesi, yaşları ve eğitimi gibi verilerle ilgili.",
    dictionaryDefinition: "(adj) relating to human populations and information such as their size, growth, ages and education",
    exampleSentence: "There have been significant demographic changes in the region.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "documented",
    phonetic: "/ˈdɒkjəməntɪd/",
    turkishMeaning: "belgelenmiş",
    turkishDefinition: "Yazıya geçirilmiş veya kayıt altına alınmış.",
    dictionaryDefinition: "(adj) recorded or written down",
    exampleSentence: "The problem is well documented in previous reports.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Belirli bir kişiye, konuya veya şeye çok fazla dikkat vermek.",
    dictionaryDefinition: "(phr v) to give a lot of attention to one particular person, subject or thing",
    exampleSentence: "Today we're going to focus on the question of homelessness.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    english: "in brief",
    phonetic: "/ɪn briːf/",
    turkishMeaning: "kısaca, özetle",
    turkishDefinition: "Sadece kısa bir süre süren veya az kelime içeren.",
    dictionaryDefinition: "(n phr) lasting only a short time or containing few words",
    exampleSentence: "In brief, the meeting was a disaster.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishMeaning: "aksine, buna karşın",
    turkishDefinition: "İki veya daha fazla şey arasındaki belirgin fark.",
    dictionaryDefinition: "(n phr) an obvious difference between two or more things",
    exampleSentence: "The weather down here is warm; in contrast, it's freezing up north.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "in theory",
    phonetic: "/ɪn ˈθɪəri/",
    turkishMeaning: "teoride, kağıt üzerinde",
    turkishDefinition: "Bir şey teorik olarak mümkün olsa da, pratikte genellikle öyle olmaması durumu.",
    dictionaryDefinition: "(n phr) if something is possible in theory, it should be possible, but often it does not happen in that way",
    exampleSentence: "In theory, women can still have children at the age of 50.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "leisure",
    phonetic: "/ˈleʒə/",
    turkishMeaning: "boş zaman",
    turkishDefinition: "Çalışmadığınız veya başka görevler yapmadığınız zaman.",
    dictionaryDefinition: "(n) the time when you are not working or doing other duties",
    exampleSentence: "What do you like doing in your leisure time?",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    english: "median",
    phonetic: "/ˈmiːdiən/",
    turkishMeaning: "medyan, ortanca",
    turkishDefinition: "Bir serideki ortadaki sayı veya miktar.",
    dictionaryDefinition: "(adj) the middle number or amount in a series",
    exampleSentence: "The median age of the population is increasing.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Emekli olmuş bir kişiye düzenli olarak ödenen para miktarı.",
    dictionaryDefinition: "(n) a sum of money paid regularly to a person who has retired",
    exampleSentence: "He is now retired and living on a state pension.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "proportion",
    phonetic: "/prəˈpɔːʃən/",
    turkishMeaning: "oran, pay",
    turkishDefinition: "Bütünün bir parçası veya payı.",
    dictionaryDefinition: "(n) a part or share of the whole",
    exampleSentence: "A large proportion of the older people live alone.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "range",
    phonetic: "/reɪndʒ/",
    turkishMeaning: "aralık, sınır",
    turkishDefinition: "Alt ve üst sınır arasındaki miktar veya sayı.",
    dictionaryDefinition: "(n) amount or number between a lower and upper limit",
    exampleSentence: "The price range is from $10 to $50.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Ana noktaların özetini yapmak.",
    dictionaryDefinition: "(phr v) to make a summary of the main points",
    exampleSentence: "To sum up, we need to reduce our expenses.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "undertake",
    phonetic: "/ˌʌndəˈteɪk/",
    turkishMeaning: "üstlenmek",
    turkishDefinition: "Bir şeyin sorumluluğunu almak ve yapmaya başlamak.",
    dictionaryDefinition: "(v) to take responsibility for and begin doing something",
    exampleSentence: "Students are required to undertake simple experiments.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "voluntary",
    phonetic: "/ˈvɒləntəri/",
    turkishMeaning: "gönüllü",
    turkishDefinition: "Zorlanmadan veya para ödenmeden yapılan.",
    dictionaryDefinition: "(adj) to do without being forced or paid to do it",
    exampleSentence: "She does voluntary work for the Red Cross.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "display",
    phonetic: "/ˈdɪspleɪ/",
    turkishMeaning: "sergilemek, göstermek",
    turkishDefinition: "Bir şeyi halka açık bir yerde göstermek.",
    dictionaryDefinition: "(v) to show something in a public place",
    exampleSentence: "The museum will display the new exhibits next week.",
    level: "B1",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Belirli bir kişiye, konuya veya şeye çok fazla dikkat vermek.",
    dictionaryDefinition: "(phr v) to give a lot of attention to one particular person, subject or thing",
    exampleSentence: "We need to focus on improving customer satisfaction.",
    level: "B1",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Birinin kim olduğu; bir kişiyi diğerlerinden farklı kılan özellikler.",
    dictionaryDefinition: "(n) who somebody is; the qualities that make a person different from others",
    exampleSentence: "He lost his sense of identity after the accident.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Bir şeyin kastedilen anlamının ne olduğuna karar vermek.",
    dictionaryDefinition: "(v) to decide what the intended meaning of something is",
    exampleSentence: "It's difficult to interpret these statistics without more context.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Bir şeyi göstermek, ifade etmek veya bir şeyin işareti olmak.",
    dictionaryDefinition: "(v) to show, express, or be a sign of something",
    exampleSentence: "The statistics reflect a change in people's spending habits.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    phonetic: "/rɪˈdʒekt/",
    turkishMeaning: "reddetmek",
    turkishDefinition: "Bir şeyi kabul etmeyi veya ona inanmayı reddetmek.",
    dictionaryDefinition: "(v) to refuse to accept or believe something",
    exampleSentence: "The committee decided to reject the proposal.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "restore",
    phonetic: "/rɪˈstɔː/",
    turkishMeaning: "onarmak, eski haline getirmek",
    turkishDefinition: "Bir şeyi önceki durumuna döndürmek.",
    dictionaryDefinition: "(v) to return something to an earlier condition",
    exampleSentence: "They spent years trying to restore the old painting.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "reveal",
    phonetic: "/rɪˈviːl/",
    turkishMeaning: "ortaya çıkarmak, ifşa etmek",
    turkishDefinition: "Daha önce gizli olan veya bilinmeyen bir şeyi göstermek.",
    dictionaryDefinition: "(v) to show something that was previously hidden or secret",
    exampleSentence: "The investigation revealed some shocking truths.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    phonetic: "/raɪt/",
    turkishMeaning: "hak",
    turkishDefinition: "Bir şeye sahip olmaya veya bir şey yapmaya izin verilmesi durumu.",
    dictionaryDefinition: "(n) to be allowed to have or do something",
    exampleSentence: "Everyone has the right to a fair trial.",
    level: "B1",
    tags: ["Unit 7"],
  },
  {
    english: "self-expression",
    phonetic: "/ˌselfɪkˈspreʃən/",
    turkishMeaning: "kendini ifade etme",
    turkishDefinition: "Birinin kişiliğini, duygularını veya fikirlerini ifade etme şekli.",
    dictionaryDefinition: "(n) how somebody expresses their personality, emotions or ideas",
    exampleSentence: "Art is a wonderful form of self-expression.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    english: "vandalism",
    phonetic: "/ˈvændəlɪzəm/",
    turkishMeaning: "vandalizm, kamu malına zarar verme",
    turkishDefinition: "Başkalarına ait mülke kasıtlı olarak zarar verme suçu.",
    dictionaryDefinition: "(n) the crime of intentionally damaging property belonging to other people",
    exampleSentence: "The park was closed due to repeated acts of vandalism.",
    level: "B2",
    tags: ["Unit 7"],
  },
  {
    ...
    turkishDefinition: "Bir şeyi değiştirmek veya bir şeyin özelliklerinin değişmesine neden olmak.",
    dictionaryDefinition: "(v) to change something or to cause the characteristics of something to change",
    exampleSentence: "We've had to alter some of our plans.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "asset",
    phonetic: "/ˈæset/",
    turkishMeaning: "varlık, mülk, değerli şey",
    turkishDefinition: "Bir kişinin, işletmenin veya kuruluşun sahip olduğu değerli şey.",
    dictionaryDefinition: "(n) something valuable owned by a person, business or organization",
    exampleSentence: "Knowledge is a company's most important asset.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Birine yardım etmek veya destek olmak.",
    dictionaryDefinition: "(v) to help",
    exampleSentence: "The company said it would assist the police in their investigation.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    english: "attempt",
    phonetic: "/əˈtempt/",
    turkishMeaning: "çabalamak, denemek",
    turkishDefinition: "Özellikle zor bir şeyi yapmaya çalışmak.",
    dictionaryDefinition: "(v) to try to do something, especially something difficult",
    exampleSentence: "He attempted to escape through a window.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Sahip olduğunuz bilgileri kullanarak bir şeyin miktarını değerlendirmek.",
    dictionaryDefinition: "(v) to judge the amount of something by using information you have",
    exampleSentence: "It's difficult to calculate the exact cost of the project.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishMeaning: "yetenekli, kapasiteli",
    turkishDefinition: "Bir şeyleri etkili ve becerikli bir şekilde yapabilen ve sonuç elde edebilen.",
    dictionaryDefinition: "(adj) able to do things effectively and skillfully, and to achieve results",
    exampleSentence: "She's a very capable young woman.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Ortak bir amaç için birlikte çalışmak.",
    dictionaryDefinition: "(v) to work together",
    exampleSentence: "The two governments agreed to cooperate on environmental issues.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishMeaning: "bağımlı",
    turkishDefinition: "Var olmak veya hayatta kalmak için birinin veya bir şeyin desteğine ihtiyaç duyan.",
    dictionaryDefinition: "(adj) needing the support of something or somebody in order to exist",
    exampleSentence: "He is heavily dependent on his parents.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "dependent",
    phonetic: "/dɪˈpen.dənt/",
    turkishMeaning: "bağımlı kimse, bakmakla yükümlü olunan kişi",
    turkishDefinition: "Maddi olarak başka bir kişi tarafından desteklenen kişi.",
    dictionaryDefinition: "(n) a person who is financially supported by another person",
    exampleSentence: "He has three dependents to support.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "devote",
    phonetic: "/dɪˈvəʊt/",
    turkishMeaning: "adamak, tahsis etmek",
    turkishDefinition: "Zaman, enerji vb. şeyleri belirli bir amaç için kullanmak.",
    dictionaryDefinition: "(v) to use time, energy, etc. for a particular purpose",
    exampleSentence: "She devoted her life to helping the poor.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "enable",
    phonetic: "/ɪˈneɪ.bəl/",
    turkishMeaning: "olanak sağlamak, mümkün kılmak",
    turkishDefinition: "Bir şeyin olmasını veya yapılmasını mümkün hale getirmek.",
    dictionaryDefinition: "(v) to make something possible",
    exampleSentence: "This technology will enable us to communicate more quickly.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "ensure",
    phonetic: "/ɪnˈʃɔːr/",
    turkishMeaning: "sağlamak, garantiye almak",
    turkishDefinition: "Bir şeyin mutlaka gerçekleşmesini sağlamak.",
    dictionaryDefinition: "(v) to make something certain to happen",
    exampleSentence: "Please ensure that all doors are locked before leaving.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Bir şeyin maliyetini, boyutunu, değerini vb. tahmin etmek veya hesaplamak.",
    dictionaryDefinition: "(v) to guess or calculate the cost, size, value, etc. of something",
    exampleSentence: "They estimate that the journey will take at least two weeks.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Bir toplum veya aile içinde yaklaşık aynı yaşta olan tüm insanlar.",
    dictionaryDefinition: "(n) all of the people of about the same age within a society or family",
    exampleSentence: "The younger generation uses technology differently.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Bir şeyi göstermek, işaret etmek veya netleştirmek.",
    dictionaryDefinition: "(v) to show, point or make clear",
    exampleSentence: "Research indicates that the treatment is effective.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishMeaning: "katılmak, iştirak etmek",
    turkishDefinition: "Bir etkinliğe dahil olmak veya yer almak.",
    dictionaryDefinition: "(v) become involved in an activity",
    exampleSentence: "Everyone is encouraged to participate in the discussion.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Emekli olmuş bir kişiye düzenli olarak ödenen para miktarı.",
    dictionaryDefinition: "(n) a sum of money paid regularly to a person who has retired",
    exampleSentence: "Many older people rely on their state pension.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    english: "permit",
    phonetic: "/pəˈmɪt/",
    turkishMeaning: "izin vermek",
    turkishDefinition: "Bir şeye izin vermek veya mümkün kılmak.",
    dictionaryDefinition: "(v) to allow something; to make something possible",
    exampleSentence: "Photography is not permitted inside the museum.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    english: "phase",
    phonetic: "/feɪz/",
    turkishMeaning: "aşama, evre",
    turkishDefinition: "Bir dizi olayın veya gelişim sürecinin herhangi bir aşaması.",
    dictionaryDefinition: "(n) any stage in a series of events or in a process of development",
    exampleSentence: "The project is currently in its final phase.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Birine ait olan arazi ve binalar.",
    dictionaryDefinition: "(n) land and buildings owned by somebody",
    exampleSentence: "The price of property in the city has increased significantly.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    english: "propose",
    phonetic: "/prəˈpəʊz/",
    turkishMeaning: "teklif etmek, önermek",
    turkishDefinition: "Olası bir planı sunmak veya tavsiye etmek.",
    dictionaryDefinition: "(v) to offer or suggest a possible plan",
    exampleSentence: "I propose that we wait until more information is available.",
    level: "B2",
    tags: ["Unit 8"],
  },
  {
    ...
    phonetic: "/reɪt/",
    turkishMeaning: "oran",
    turkishDefinition: "Belirli bir dönemdeki bir şeyin miktarı veya seviyesi.",
    dictionaryDefinition: "(n) the amount of something in a particular period",
    exampleSentence: "The crime rate has dropped over the last five years.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    phonetic: "/rɪˌspɒnsɪˈbɪləti/",
    turkishMeaning: "sorumluluk",
    turkishDefinition: "Birine veya bir şeye bakma, ilgilenme görevi.",
    dictionaryDefinition: "(n) the duty to take care of somebody or something",
    exampleSentence: "Parents have a responsibility to look after their children.",
    level: "B1",
    tags: ["Unit 8"],
  },
  {
    ...
    turkishDefinition: "Birinin yaşı nedeniyle çalışmayı bıraktığı zaman veya durum.",
    dictionaryDefinition: "(n) the point at which somebody stops working due to their age",
    exampleSentence: "He is saving money for his retirement.",
    level: "B2",
    tags: ["Unit 8"],
  }
];
